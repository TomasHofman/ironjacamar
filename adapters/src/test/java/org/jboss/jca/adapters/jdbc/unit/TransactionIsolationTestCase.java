...
public class TransactionIsolationTestCase {
   ...
   public static Descriptor createDescriptor() throws Exception {
      ...
      InputStreamDescriptor isd = new InputStreamDescriptor("transaction-isolation-ds.xml",
            cl.getResourceAsStream("transaction-isolation-ds.xml"));
      return isd;
   }
