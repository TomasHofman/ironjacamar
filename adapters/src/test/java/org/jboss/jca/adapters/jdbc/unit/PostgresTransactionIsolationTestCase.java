...
public class PostgresTransactionIsolationTestCase {
   ...
   public static Descriptor createDescriptor() throws Exception {
      ...
      InputStreamDescriptor isd = new InputStreamDescriptor("postgresql-transaction-isolation-ds.xml",
            cl.getResourceAsStream("postgresql-transaction-isolation-ds.xml"));
      return isd;
   }
   ...
   private void runApplicationCode(DataSource ds) throws Throwable {
      ...
      /*PreparedStatement st = c.prepareStatement("select 2");
      st.execute();
      st.close();*/
